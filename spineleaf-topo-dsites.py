...
def emptyNet():
    ...
    controllers.append(net.addController('c1', controller=RemoteController, ip="172.23.0.3", port=6633))
    controllers.append(net.addController('c2', controller=RemoteController, ip="172.24.0.3", port=6633))
    controllers.append(net.addController('c3', controller=RemoteController, ip="172.25.0.3", port=6633))
